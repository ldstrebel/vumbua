...
### Node Spectrum & Specific Spires

Each node type grants a temporary **Boon** — a power-up that lasts until the next sync. Spires are categorized by their Connection Units (CU).
...
- **Chime Spire (Origin: Gilded)** | **80 CU (3 charges)**
  - **Look & Feel:** Gold compass arc. An elaborate array of organ-pipe brass columns. When struck, it physically plays a massive, sustained chord heard across the basin.
  - **The Boon:** *Harmonic Lock* stabilizes mass reduction physics.
- **Umber Crystal (Origin: Umbra Mountain)** | **70 CU (3 charges)**
  - **Look & Feel:** Deep violet arc of faceted obsidian that glows cold.
  - **The Boon:** *Deficit Shear* provides an instant, flat 15 bonus to craft draw reduction.

#### ⚙️ The Moderate Spires (The Reliable Core)
- **Soft Forge (Origin: Relina)** | **45 CU (2 charges)** — Bronze-amber arc. Surface shimmers like slow liquid metal.
- **Lift Stone (Origin: Juxta)** | **40 CU (2 charges)** — Blue-grey arc. Smooth granite projecting a massive updraft.
- **Focus Glass (Origin: Timon)** | **35 CU (2 charges)** — Clear/prismatic arc. A giant lens structure that bends light, easily disorienting strikers.
- **Live Soil (Origin: Feltland)** | **35 CU (2 charges)** — Earth brown arc smelling of fresh soil.

#### 🏁 The Standard Spires (The Mid-Field Farm)
Bread-and-butter nodes. Crews fight tooth-and-nail over these to keep drain rates at bay.
- **Prism Falls (Origin: Settika)** | **30 CU (2 charges)**
- **Whetstone (Origin: Shepta)** | **30 CU (2 charges)** — Dark charcoal arc shooting visible sparks.
- **Friction Needles (Origin: Lenoa)** | **30 CU (2 charges)** — 100% frictionless silver needles.
- **Dew Crystal (Origin: Prima)** | **25 CU (2 charges)**
- **Speaking Stone (Origin: Octo)** | **25 CU (2 charges)** — Smooth stone letting out a low-frequency hum.

#### 🗡️ The Minor Spires (The Niche / Stealth Hits)
Low CU, but pop up in weird places and offer tactical advantages.
- **Silent Silt (Origin: Nstyl)** | **20 CU (1 charge)** — Matte grey-brown. Absolutely zero noise. *Mute Wake* completely silences the rig's engines.
- **Clockwork Blooms (Origin: Bloomfield)** | **20 CU (1 charge)** — Copper metal flowers that tick and clack.
- **Living Scent Wood (Origin: Minnow)** | **20 CU (1 charge)** — Warm amber arc made of fragrant wood that 'gives' under the Prong.
- **Breathable Algae (Origin: Bay of Breath)** | **20 CU (1 charge)** — Bioluminescent green arc shooting bubbles.
- **Trench Seeds (Origin: Trail-Tail Trench)** | **15 CU (1 charge)** — Deep teal arc accessible only in deep water.
