...
| Current | New |
|---|---|
| `sessions/data/raw/sN-raw.md` | `sessions/sN/raw.md` |
| `sessions/data/index/sN-*` | `sessions/sN/*` |
| `sessions/data/clean/sN-*` | `sessions/sN/*` |
| `sessions/data/clean/blocks/sN-*` | `sessions/sN/blocks/` |
...
- All `data/{raw,index,clean}` literals in `prep_raw.py`,
...
- No `sessions/data/` references remain in scripts or skills.
