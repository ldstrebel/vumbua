...
Related: garbled speech-to-text lines must be flagged/normalized at manifest time (`garbled: true` + assumption log), or the writer novelizes gibberish literally. Plan source of truth: `sessions/planning/transcript-pipeline-plan.md`.
