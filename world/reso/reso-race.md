# 🏁 Resonance Race (Session 5 Hub)

> **Quick DM Guide:** The Resistance Race is a montage spectacle, not a combat encounter. It acts as Harmony propaganda to teach citizens about newly integrated territories (like the Ash-Blood Isles). **Your goal:** Cycle through the timeline, let the PCs pick their weekly focus, drop NPC hooks in the spectator stands, run a high-energy 15-minute narrative play-by-play of the race itself, and then use the aftermath to pivot into class mechanics and the missing Spire mystery.

### 🔗 Quick Indexes
- **[[reso-race-prep-vumbua-hangars]]** (Monday/Tuesday Hooks)
- **[The Rigs & Teams]([[resonance-racers]])** (Who is competing)
- **[The Lore & Mechanics]([[reso-race context]])** (How Spires and Connection work)
- **[[#🏟️ The NPC Spectator Sandbox Session 5]]** (NPCs in the stands)
* [[#Race Montage — Scene by Scene]]  (The 4-beat play-by-play)
* [[reso-race-enterprise]] for the day to day logistics
...
| NPC | Action / Hook | The "Intel" or Reward |
| :--- | :--- | :--- |
| [[rill\|Rill]] | Prepping **The Reed-Runner** (Team 6) or arguing with transport crews about the "vibration stress" on the [[mizizi-petrified-forest]] samples. | **The Quest:** She needs a crew for a "silent run" back to the forest. She is using the race as a data-gathering mission for her navigation AI. |
...
4. **The Rig Heist:** A group of "Pit-Row Independents" led by **[[vex]]** attempts to jack a rig from the launch gantry during the opening horn. The PCs see the struggle from their tier.
---
...
Use the beats below to run the race as a montage. Each one is a GM-read description that can be delivered in 30–60 seconds, with player reaction space after. Pick 4–5.

---

**OPENING — Before the First Horn**

> The starting line sits at the southern mouth of the basin, where the canyon opens wide into a mix of solid earth and deep turquoise water. The majority of the twelve rigs idle at ground level—Stinger's hover-bike vibrating near the water's edge, dwarfed by Goliath's massive three-storey hull rumbling on the dirt. Set far back behind the starting line is the massive Walker-Core crane, offering an optional aerial launch point. Pudge's gryphon-hybrid hangs from the gantry, willingly taking the rear distance penalty to gain altitude and catch a thermal off the rim.
> The Apex Ring holds half a million people. Right now, none of them are making a sound.
> *The first horn fires.*

**HORN 1 — T+0 — The Launch**
...
> In the Petrified Forest, the first spires are struck. Shatter Stamper hits an Aero-Static spire, losing 90% of its weight to leap a canyon wall. Marble Wall isn't racing; they are hunting, pinning a soloist team against the petrified bark. Stinger keeps slipping away.
> Mid-basin rigs start flipping LEDs to green. Shatter Stamper at three red-to-green. Dancer & Fabian at one.
> North arc: Pudge is still circling with two red lights.
...
> The second horn fires. New spires erupt across the basin. A Crystalline node appears right in front of Dancer & Fabian. They strike it, turning their hull into semi-fluid glass to pass through a narrow crack. 
> A Feltland node in the estuary channel pulses green. Dancer & Fabian's scoreboard flips to double-green. The crowd that was watching Shatter Stamper suddenly isn't.
> Pudge strikes a Vitruvian node, doubling their sync duration, but they're still behind the Global Amplitude line.
...
> The Timon glass has been avoiding the north for twenty minutes. Pudge is making slow banking passes over the volcanic flat.
> Only three teams left in contention for the Grand Resonator. Marble Wall is bearing down on Dancer & Fabian. Dancer & Fabian hit a Kinetic-Echo spire, perform an instant U-turn on their hard-light trail, and let the heavy rig sail past into a canyon wall!
...
> The north arc on the Apex Compass goes **gold**. The Gilded Chime Spire has erupted from the volcanic flat. Pudge is already there, prong extended.
> *"That's not luck,"* someone mutters in the stands.

---

**THE GRAND RESONATOR — End**

> Pudge reaches the Grand Resonator. The gryphon hovers as the arm extends. The Resonator discharges.
> A blinding pillar of light from the dead centre of the basin. The crowd erupts. **Pudge wins!**
> Dancer & Fabian's Glass-Sail is somewhere in the east canyon approach — they were close.
