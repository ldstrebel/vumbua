...
Usage:
  ...
  2. List available ElevenLabs voices on your account:
     python sessions/_scripts/generate_audiobook.py --check-voices

  3. Dry-run parse s11-clean-story.md (no API quota used):
     python sessions/_scripts/generate_audiobook.py --input sessions/data/clean/s11-clean-story.md --parse-only

  4. Generate audiobook MP3s:
     python sessions/_scripts/generate_audiobook.py --input sessions/data/clean/s11-clean-story.md --output-dir campaign/audio/s11
"""
...
def create_custom_voice(character, description):
    ...
    try:
        ...
        out_path = Path("campaign/audio/samples")
        ...
        print(f"\n💡 Listen to the MP3 previews in campaign/audio/samples/!")
...
def main():
    ...
    parser.add_argument("--manifest", help="Path to pre-audited Audio Manifest JSON (e.g. campaign/audio/s11/s11_audio_manifest.json)")
    parser.add_argument("--input", default="sessions/data/clean/s11-clean-story.md", help="Path to story markdown file")
    parser.add_argument("--output-dir", default="campaign/audio/s11", help="Output directory for MP3 files")
    ...
    if args.hello_world:
        ...
        generate_audiobook(sample_blocks, "campaign/audio/test", DEFAULT_VOICE_MAP)
        print("\n🎉 Hello World test complete! Audio saved to: campaign/audio/test/\n")
        return
    ...
    if args.cast_sample:
        ...
        generate_audiobook(sample_blocks, "campaign/audio/samples", DEFAULT_VOICE_MAP)
        print("\n🎉 Cast samples complete! Listen to files in: campaign/audio/samples/\n")
        return
