"""Generates sessions/data/index/s3-manifest.json and validates it."""
...
def build_manifest():
    ...
    indexed_path = os.path.join(base_dir, "data", "index", "s3-raw-indexed.md")
    manifest_path = os.path.join(base_dir, "data", "index", "s3-manifest.json")
    attr_path = os.path.join(base_dir, "data", "index", "s3-attribution.json")
    ...
    manifest = {
        "session_id": "s3",
        "raw_file": "data/index/s3-raw-indexed.md",
