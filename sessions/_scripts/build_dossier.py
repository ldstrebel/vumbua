...
Also writes _ops/review/sN-dossier.md: raw vs rendered side by side for every
...
def main() -> None:
    ...
    assumptions_path = ROOT / "data" / "index" / f"{session}-assumptions.json"
    story_path = ROOT / "data" / "clean" / f"{session}-clean-story.md"
    dossier_path = ROOT.parent / "_ops" / "review" / f"{session}-dossier.md"
