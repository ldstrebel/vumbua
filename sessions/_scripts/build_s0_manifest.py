"""Generates sessions/data/index/s0-manifest.json and validates it."""
...
def build_manifest():
    ...
    indexed_path = os.path.join(base_dir, "data", "index", "s0-raw-indexed.md")
    ...
    manifest = {
        "session_id": "s0",
        "indexed_file": "sessions/data/index/s0-raw-indexed.md",
