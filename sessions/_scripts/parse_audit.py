...
def write_audit_report(blocks, warnings, out_path):
    with open(out_path, "w", encoding="utf-8") as f:
        ...
        f.write("Source: sessions/data/clean/s11-clean-story.md\n")
...
if __name__ == "__main__":
    story_path = "sessions/data/clean/s11-clean-story.md"
    out_path = "sessions/_scripts/parse_audit_report.txt"
