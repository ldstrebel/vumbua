...
2. Write a script to help seed/annotate the existing [`s12-clean-story.md`](file:///d:/Code/vumbua/sessions/data/clean/s12-clean-story.md) with inline `<!-- Lxxxx -->` comments.
