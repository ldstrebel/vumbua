"""Generates sessions/data/index/s2-manifest.json and validates it."""
...
def build_manifest():
    ...
    manifest_path = os.path.join(base_dir, "data", "index", "s2-manifest.json")
    attr_path = os.path.join(base_dir, "data", "index", "s2-attribution.json")
    ...
    manifest = {
        "session_id": "s2",
        "indexed_file": "sessions/data/index/s2-raw-indexed.md",
