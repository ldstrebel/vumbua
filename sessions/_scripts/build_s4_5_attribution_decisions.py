...
def main():
    lines = open("sessions/data/index/s4.5-raw-indexed.md", encoding="utf-8").readlines()
    ...
    with open("sessions/data/index/s4.5-attribution-decisions.json", "w", encoding="utf-8") as f:
