...
Output: sessions/data/clean/<sid>-clean-story.annotated.md  (never
...
def main():
    ...
    manifest_path = os.path.join(base, "data", "index", f"{sid}-manifest.json")
    story_path = os.path.join(base, "data", "clean", f"{sid}-clean-story.md")
    out_path = os.path.join(base, "data", "clean", f"{sid}-clean-story.annotated.md")
