...
def reconcile():
    base_dir = "sessions"
    manifest_path = os.path.join(base_dir, "data", "index", "s12-manifest.json")
    ...
    for block in manifest.get("scene_blocks", []):
        ...
        block_path = os.path.join(blocks_dir, f"s12-scene-{scene_id:02d}.md")
        ...
        # Remove any forbidden ### subheadings
