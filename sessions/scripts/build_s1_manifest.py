"""Generates sessions/transcripts/index/s1-manifest.json and validates it."""
...
def build_manifest():
    ...
    indexed_path = os.path.join(base_dir, "transcripts", "index", "s1-raw-indexed.md")
    manifest_path = os.path.join(base_dir, "transcripts", "index", "s1-manifest.json")
    ...
    manifest = {
        "session_id": "s1",
        "indexed_file": "sessions/transcripts/index/s1-raw-indexed.md",
