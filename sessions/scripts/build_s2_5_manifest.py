"""Generates sessions/transcripts/index/s2.5-manifest.json and validates it."""
...
def build_manifest():
    ...
    indexed_path = os.path.join(base_dir, "transcripts", "index", "s2.5-raw-indexed.md")
    manifest_path = os.path.join(base_dir, "transcripts", "index", "s2.5-manifest.json")
    attr_path = os.path.join(base_dir, "transcripts", "index", "s2.5-attribution.json")
    ...
    manifest = {
        "session_id": "s2.5",
        "raw_file": "transcripts/index/s2.5-raw-indexed.md",
