"""Generates sessions/transcripts/index/s5-manifest.json and validates it."""
...
def build_manifest():
    ...
    indexed_path = os.path.join(base_dir, "transcripts", "index", "s5-raw-indexed.md")
    manifest_path = os.path.join(base_dir, "transcripts", "index", "s5-manifest.json")
    attr_path = os.path.join(base_dir, "transcripts", "index", "s5-attribution.json")
    ...
    manifest = {
        "session_id": "s5",
        "raw_file": "transcripts/index/s5-raw-indexed.md",
