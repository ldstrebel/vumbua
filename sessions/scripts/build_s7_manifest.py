"""Generates sessions/transcripts/index/s7-manifest.json and validates it."""
...
def build_manifest():
    ...
    indexed_path = os.path.join(base_dir, "transcripts", "index", "s7-raw-indexed.md")
    manifest_path = os.path.join(base_dir, "transcripts", "index", "s7-manifest.json")
    attr_path = os.path.join(base_dir, "transcripts", "index", "s7-attribution.json")
    ...
    manifest = {
        "session_id": "s7",
        "raw_file": "transcripts/index/s7-raw-indexed.md",
