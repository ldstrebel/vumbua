...
def check_sterling_alignment():
    with open("sessions/planning/s12-finale/s12-intro-sterling.md", "r", encoding="utf-8") as f:
        master_script = f.read()

    with open("sessions/transcripts/clean/s12-clean-story.md", "r", encoding="utf-8") as f:
        story_text = f.read()
