"""Generates sessions/transcripts/index/s4.5-manifest.json and validates it."""
...
def build_manifest():
    ...
    indexed_path = os.path.join(base_dir, "transcripts", "index", "s4.5-raw-indexed.md")
    manifest_path = os.path.join(base_dir, "transcripts", "index", "s4.5-manifest.json")
    attr_path = os.path.join(base_dir, "transcripts", "index", "s4.5-attribution.json")
    ...
    scene_defs = [
        {"id": 1, "title": "OOC Pre-Session Setup & Chit-Chat", "range": [1, 122], "ooc": True},
        {"id": 2, "title": "Roots, Karma, and Morning Bells", "range": [123, 220], "ooc": False},
        {"id": 3, "title": "The Talking Stones & The Breakfast Line", "range": [221, 350], "ooc": False},
        {"id": 4, "title": "Professor Thorne & The Dead Island", "range": [351, 480], "ooc": False},
        {"id": 5, "title": "The Edge of the World & Sterling Hall", "range": [481, 620], "ooc": False},
        {"id": 6, "title": "OOC Post-Session Wrap-Up & Scheduling", "range": [621, total_lines], "ooc": True}
    ]
    ...
    manifest = {
        "session_id": "s4.5",
        "raw_file": "transcripts/index/s4.5-raw-indexed.md",
        "raw_file_hash": file_hash,
        "total_raw_lines": total_lines,
        "target_word_budget": 5000,
