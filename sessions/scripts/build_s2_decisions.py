"""Build sessions/transcripts/index/s2-attribution-decisions.json deterministically."""
...
def build_decisions():
    ...
    out_path = os.path.join(base_dir, "transcripts", "index", "s2-attribution-decisions.json")
