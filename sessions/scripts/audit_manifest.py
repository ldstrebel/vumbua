...
Usage:
  python sessions/scripts/audit_manifest.py \
    --manifest sessions/audio/s11/s11_audio_manifest.json \
    --story sessions/transcripts/clean/s11-clean-story.md \
    --report sessions/audio/s11/manifest_audit_report.md
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--report", default="sessions/audio/s11/manifest_audit_report.md", help="Path to audit report markdown file")
