...
def build_decisions():
    ...
    guesses_path = os.path.join(base_dir, "transcripts", "index", "s2.5-speaker-guesses.json")
    out_path = os.path.join(base_dir, "transcripts", "index", "s2.5-attribution-decisions.json")
