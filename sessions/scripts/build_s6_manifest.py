"""Generates sessions/transcripts/index/s6-manifest.json and validates it."""
...
def build_manifest():
    ...
    indexed_path = os.path.join(base_dir, "transcripts", "index", "s6-raw-indexed.md")
    manifest_path = os.path.join(base_dir, "transcripts", "index", "s6-manifest.json")
    attr_path = os.path.join(base_dir, "transcripts", "index", "s6-attribution.json")
    ...
    manifest = {
        "session_id": "s6",
        "raw_file": "transcripts/index/s6-raw-indexed.md",
