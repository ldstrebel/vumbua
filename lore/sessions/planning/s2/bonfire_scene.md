...
- A few Gold-rank students observing from a distance, clearly slumming
...
**Prompt:** The fire is burning. The night is young. Who do you approach?
...
**Exploration Options:**
- [Wander Away from the Fire](#wander-away) - The industrial zone at night
- [Go to Bed Early](#go-to-bed) - Skip the social scene entirely
...
### Serra Vox
*The Eager Ally (Gold / Bard / Squad 01)*

Serra is still buzzing from meeting the party at the crane. She's planted herself near the group, notebook in hand, asking too many questions with too much enthusiasm.
...
### Cassius Thorne
*The Nervous Student (Gold / Paladin / Squad 01)*

A well-dressed boy in a slightly rumpled Academy uniform, crouching behind the bonfire pit's stone edge. He's clearly not supposed to be here---his family is at the Arch-Duke's gala in the Sky-Spire.
...
> [!TIP]
> **Gain Insight: Cartography**
> The "Dead-Stick Drop" is a myth. The manual says **Synchronized Helix** if you want to pass the Z-Axis Paradox in tomorrow's exam.

> [!TIP]
> **Gain Insight: The Gen-Ed Exam**
...
**If players ask about maps:**
> "I got a partial layout of the campus---the *real* one, not the tourist version. Shows the maintenance tunnels under the Deep-Hull. Cost you... something interesting. I don't take receipts."

**If players ask about the Void-Lily:**
> "There's this flower that grows in the scrap heaps near the perimeter. Harmony says it's a pest---kill on sight. But the old crews? They say if you leave it alone, the Void-Beasts won't come near you. Something about the smell. I saw one up close once. Prettiest thing I've ever seen, right before I almost died."

**If players ask about the exam:**
> "The exam's outside the fence, yeah? Word is, Hesperus lost a student last year. Like, *lost* lost. Kid walked into the fog and just... poof. They say the fog has a voice."

> [!TIP]
> **Gain Insight: Xenobiology**
> The Void-Lily supports the ecosystem. Sometimes you gotta **lie to the suits (Environmental Masking)** to save the forest.

> [!TIP]
> **Gain Insight: First Contact**
> If you act like a soldier, they'll act like a warrior. **Be vulnerable (Vulnerability)**.

> [!TIP]
> **Gain Insight: Campus Layout**
> [[Lucky]] has a partial map of the maintenance tunnels under the Deep-Hull. He'll trade it for "something interesting"---not receipts, not money. Something *weird*.
...
> [!TIP]
> **Gain Insight: Anchor of Self**
> It's not about magic. Hold onto your **Flaw**---it's the only thing that's real when the fog tries to take your identity.

> [!TIP]
> **Gain Insight: Crisis Management**
...
**If players ask about Nodes:**
> "They yell orders at the Nodes. 'Produce! Stabilize! Integrate!' But if a Node is weeping... you cannot cure sadness with a hammer. You must listen. You must match its frequency. You must cry with it before it will trust you."

**If players ask about her squad:**
> "Squad 03. We go where the silence is thickest. We find the things that don't want to be found." (Long pause) "I volunteered."

**If Iggy approaches (important):**
> ([[Nyx]] studies Iggy for an uncomfortable amount of time) "You smell like deep water. And stone. Where did you say you were from?"
...
- If Iggy deflects well, Nyx will back off but remain suspicious. If Iggy fumbles, Nyx won't report him---but she'll start watching him closely.
- Her insight about "matching frequency" with weeping Nodes is the single most important mechanical clue in the bonfire scene. It is the answer to the [[Mizizi]] Integration puzzle: you don't force knowledge into the forest---you grieve with it.
...
> Rill has been at the Academy for over a year and works directly with the Dean. She's changed---cleaner, faster, more serious. She's researching what the Petrified Forest trees *remember*.

**GM Notes:**
- [[Kojo]] is the party's best Mizizi contact at the Academy. He's the bridge between the newcomers (Britt/Aggie) and the Academy's Mizizi community.
- His line about "the scroll and the ink" is his way of processing the Shattered Empire revelation---that the Mizizi aren't gardeners but Archivists.
- His mention of Mosi fighting the [[The Verdant Trust|Verdant Trust]] sets up a faction conflict the party can get involved in.
...
> The smoke from the fire is drifting in an unusual pattern. It's not rising straight up---it's curling toward the treeline where the Petrified Forest begins. Like the forest is... inhaling.

> [!TIP]
> **Gain Insight: The Resonance**
> The True Flame is interacting with clan members differently. Fire, Earth, and Forest are responding to each other's proximity. This is the first observable evidence of the Shattered Circuit---the Nodes "reaching" for each other through their representatives.
...
**The Perimeter Fence:** A chain-link barrier with teal-glowing ley-lines woven through it. Beyond it: darkness, and occasionally, movement. Something large shifts in the fog.

**The Steam Tunnels (if [[Iggy]] investigates Block 99):** A network of maintenance tunnels running under the geothermal plant. The air is warm and pressurized---comfortable for someone used to deep-earth living. The tunnels connect to the Walker-Core. Iggy can hear the Loom humming from below.

> [!TIP]
> **Gain Insight: Campus Layout (Iggy)**
> The steam tunnels under Block 99 connect to the Walker-Core. The air pressure increases as you go deeper---almost like home. The Loom's hum is audible from below.
